...
# WARNING
#
# This script was changed by Jelle Kralt <jelle.kralt@klm.com> to add
# password protection to the Redis cluster. When upgrading the Redis version
# The changes to this file should be ported to the new redis-trib script

# All the changes are marked with a start / stop comment:
# #BWFIX start
# ....
# #BWFIX end
    ...
    def connect(o={})
        ...
        begin
            ...
            if @info[:password] != nil
                ...
                #BWFIX This is the original script, used to connect without password
